    ...
    <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right">
            ...
            <div class="user-profile-area">
                ...
                <a href="<?php echo site_url('member/profile/index'); ?>" class="dropdown-item"><i class="ti-user text-default" aria-hidden="true"></i> My profile</a>
                <a href="<?php echo site_url('member/login/do_logout'); ?>" class="dropdown-item"><i class="ti-unlink text-warning" aria-hidden="true"></i> Sign-out</a>
            </div>
        </div>
    </li>
</ul>