            ...
            <div class="ecaps-logo">
                <?php
				  ...
				  if(is_file(APPPATH.'../public/'.$file_company_logo)&&file_exists(APPPATH.'../public/'.$file_company_logo))
					{
				 ?>
					 <a href="<?php echo site_url('membercontroller'); ?>"><img class="desktop-logo" src="<?php echo base_url(); ?>public/<?=$file_company_logo?>" alt="Desktop Logo"> <img class="small-logo" src="<?php echo base_url(); ?>public/<?=$file_company_logo?>" alt="Mobile Logo"></a>
				<?php
					}
					else
					{
				?>
					 <a href="<?php echo site_url('membercontroller'); ?>"><img class="desktop-logo" src="<?php echo base_url(); ?>public/uploads/logo.png" alt="Desktop Logo"> <img class="small-logo" src="<?php echo base_url(); ?>public/uploads/logo.png" alt="Mobile Logo"></a>
				<?php		
					}
				  ?>
            </div>
                    ...
                    <div class="mobile-logo mr-3 mr-sm-4">
                        <?php
                          ...
                          if(is_file(APPPATH.'../public/'.$file_company_logo)&&file_exists(APPPATH.'../public/'.$file_company_logo))
							{
						 ?>
						     <a href="<?php echo site_url('membercontroller'); ?>"><img src="<?php echo base_url().'public/'.$file_company_logo?>"></a>
						<?php
							}
							else
							{
						?>
						     <a href="<?php echo site_url('membercontroller'); ?>"><img src="<?php echo base_url(); ?>public/uploads/logo.png" alt="Mobile Logo"></a>
						<?php		
							}
						  ?>
                    </div>
