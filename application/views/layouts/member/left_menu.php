...
<nav>
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($this->router->fetch_class()=="membercontroller"){?>
					class="active" <?php }?>><a href="<?php echo site_url('membercontroller'); ?>"><i class="icon_lifesaver"></i> <span>Dashboard</span></a></li>
        <?php
		     $menu_open =  false; 
        ...
        <li class="treeview <?php if($menu_open==true){?>menu-open<?php }?>">
            ...
            <ul class="treeview-menu" <?php if($menu_open==true){?>style="display: block;"<?php }?>>
                <li <?php if($this->router->fetch_class()=="profile"){?>class="active"<?php }?>><a href="<?php echo site_url('member/profile/index'); ?>">- Profile</a></li>
            </ul>
        </li> 
<li <?php if($this->router->fetch_class()=="complaint"){?>class="active"<?php }?>><a href="<?php echo site_url('member/complaint/index'); ?>"><i class="icon_table"></i>Complaint</a></li>
