...
<nav>
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($this->router->fetch_class()=="category"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/category/index'); ?>"><i class="icon_table"></i>Category</a></li>
<li <?php if($this->router->fetch_class()=="complaint"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/complaint/index'); ?>"><i class="icon_table"></i>Complaint</a></li>
