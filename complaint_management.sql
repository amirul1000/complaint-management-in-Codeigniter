...
(1, 'defect', '2020-04-06 07:44:31', NULL),
(2, 'delay', '2020-04-06 07:44:39', NULL),
(3, 'not delivered', '2020-04-06 07:45:19', NULL);
...
CREATE TABLE `complaint` (
  ...
  `address` text,
  `status` enum('active','inactive','rejected','solved') DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `complaint` (`id`, `users_id`, `category_id`, `subject`, `description`, `file_picture`, `cell_phone`, `email`, `address`, `status`, `created_at`, `updated_at`) VALUES
(1, 9, 3, 'ss', 'sss', 'uploads/images/complaint/Rectangle 20.png', '332', 'amirrucst@gmail.com', 'C-20,JAkir Hossain Road,Block-E\r\nMd-pur', 'active', '2020-04-06 08:13:47', NULL),
(2, 9, 3, 'hhh', 'hhh', 'uploads/images/complaint/Rectangle 20.png', '65656565', 'drtger@dfdfdf.com', '565656', 'active', '2020-04-06 08:20:31', NULL);
